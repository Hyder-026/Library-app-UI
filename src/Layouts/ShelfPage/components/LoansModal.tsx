...
export const LoansModal: React.FC<{
    ...
    return (
        <div className="modal fade" id={props.mobile ? `mobilemodal${props.shelfCurrentLoan.book?.id}` :
            `modal${props.shelfCurrentLoan.book?.id}`} data-bs-backdrop='static' data-bs-keyboards='false'
                                    ...
                                    <div className="col-2">
                                        {
                                            props.shelfCurrentLoan.book?.img ?
                                                <img src={props.shelfCurrentLoan.book?.img} width={56} height={57} alt="Book" />
                                                :
                                                <img src={require('../../../Images/BooksImages/book-luv2code-1000.png')} width={56} height={57} alt="Book" />
                                        }
                                    </div>
