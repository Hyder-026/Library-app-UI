...
export const HistoryPage = () => {
    ...
    return (
        <div className="mt-2">
                                        ...
                                        <div className="row g-0">
                                            <div className="col-md-2">
                                                <div className="d-none d-lg-block">
                                                    {
                                                        history.img ?
                                                            <img src={history.img} alt="Book" height={196} width={123} />
                                                            :
                                                            <img src={require('../../../Images/BooksImages/book-luv2code-1000.png')} alt="Default Book"
                                                                height={196} width={123} />
                                                    }
                                                </div>
            ...
            {
                totalPages > 1 && 
                <Pagination key={currentPage} currentPage={currentPage} totalPages={totalPages} paginate={paginate} />
            }
        </div>
    );
}