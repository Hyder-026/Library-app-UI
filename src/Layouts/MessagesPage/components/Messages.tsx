...
export const Messages = () => {
    ...
    return (
        <div className="mt-2">
                                        ...
                                        <div>
                                            <h5>Response: </h5>
                                            {
                                                message.response && message.adminEmail ?
                                                    ...
                                                    :
                                                    <p>
                                                        <i>Pending reponse from adminstration. Please be patient.</i>
                                                    </p>
                                            }
                                        </div>
                                    </div>
            ...
            {
                totalPages > 1 && <Pagination key={currentPage} currentPage={currentPage} totalPages={totalPages} paginate={paginate} />
            }
        </div>
    );
}