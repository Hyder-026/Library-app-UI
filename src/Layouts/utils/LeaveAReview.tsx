            ...
            <StarReview Rating={starInput} size={32} />
            {
                ...
                <form method="POST" action="#">
                    ...
                    <div className="mb-3">
                        ...
                        <textarea name="description" id="submitReviewDescription" cols={10} rows={3}
                            className="form-control" placeholder="Optional" onChange={e => setReviewDescription(e.target.value)}>
                        </textarea>
                    </div>
                    <div>
