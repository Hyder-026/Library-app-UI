...
export const ReviewListPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviews = async () => {
            ...
            setTotalPages(responseJsonReviews.page.totoalPages);
    ...
    return (
        <div className="container m-5">
            ...
            {totalPages > 1 && <Pagination key={currentPage} currentPage={currentPage} paginate={paginate} totalPages={totalPages} />}
        </div>
    );
}