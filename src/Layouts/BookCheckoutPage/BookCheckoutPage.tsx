...
export const BookCheckoutPage = () => {
    ...
    const [isLoadingCurrentLoansCount, setIsLoadingCurrentLoansount] = useState(true);
        ...
        <div>
            ...
            <div className="container d-none d-lg-block">
                ...
                <div className="row mt-5">
                    ...
                    <CheckoutAndReview book={book} mobile={false} key={book?.id} currentLoansCount={currentLoansCount}
            ...
            <div className="container d-lg-none mt-5">
                ...
                <CheckoutAndReview book={book} mobile={true} key={book?.id} currentLoansCount={currentLoansCount}
                    isAuthenticated={authState?.isAuthenticated} isCheckedOut={isCheckedOut} checkoutBook={checkoutBook}
                    isReviewLeft={isReviewLeft} submitReview={submitReview} />
                <hr />
